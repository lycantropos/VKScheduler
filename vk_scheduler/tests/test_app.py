...
class TestModels(unittest.TestCase):
    def setUp(self):
        self.raw_post = dict(
            id=5, from_id=-129836227, owner_id=-129836227, date=1476651285, marked_as_ads=0, post_type='post',
            text=(
                ...
                'Sed aliquet, nibh eget vehicula cursus, mauris neque porttitor lectus, in aliquam arcu arcu in ex.\n'
                '\n'
                ...
                'Aliquam iaculis consectetur convallis.\n'
                '\n'
                ...
                'Etiam eget dui nulla. '
                'Proin ac consequat nulla. '
            ...
            can_edit=1, created_by=33151248, can_delete=1,
            can_pin=1,
            attachments=[
                {
                    'type': 'photo',
